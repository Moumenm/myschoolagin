...
const recordBtnStyles = {
    'بدء التسجيل': `background-color: white;
                        border: 2px solid red;
                        color: black;`,
    'يتم التسجيل': `background-color: red;
...
const handleRecordClick = () => {
    ...
    if (recBtn.innerText === 'بدء التسجيل' || recBtn.innerText === 'يتم التسجيل') {
...
const handleVideoSubmittion = () => {
    ...
    progress.innerText = "تتم الترجمة"
}
